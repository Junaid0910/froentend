  ...
  return (
    <div className="home-container">
      ...
      <section className="hero-section" ref={heroRef}>
        <div className="hero-content">
          ...
          <p className="description">
            Start converting your speech to text in seconds. It's fast, accurate, and free! Join thousands of students, professionals, and writers who are already boosting their productivity with Voice2Text.
          </p>
      ...
      <section className="testimonials-section" ref={testimonialsRef}>
        ...
        <p className="section-subtitle">Read how Voice2Text empowers creators, writers, and executives around the globe.</p>
        ...
        <div className="testimonials-grid">
          <div className="testimonial-card">
            ...
            <p className="testimonial-text">
              "Voice2Text has completely changed the way I take lecture notes. It's fast, accurate, and incredibly easy to use. The voice commands make new paragraphs trivial!"
            </p>
          ...
          <div className="testimonial-card">
            ...
            <FaQuoteLeft className="quote-icon" />
            <p className="testimonial-text">
              "I use Voice2Text for transcribing long executive board meetings, and it saves me hours of transcripts. The offline client-side PDF export is absolutely brilliant!"
            </p>
          ...
          <div className="testimonial-card">
            ...
            <FaQuoteLeft className="quote-icon" />
            <p className="testimonial-text">
              "As a creative writer, Voice2Text helps me capture wild ideas on the go. It's a frictionless, essential tool in my drafting and editing workflow."
            </p>
      ...
      <section className="cta-section" ref={ctaRef}>
        ...
        <p>
          Join thousands of productive individuals who are already redefining their note-taking workflows with Voice2Text. Sign up today and experience the speed.
        </p>
